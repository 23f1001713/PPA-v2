...
# from backend.app.models import db , Student,User,Company,Application,PlacementDrives,ceo
...
#     total_blocked = len(Company.query.filter(Company.status != 'APPROVED').all())
#     total_approved = len(Student.query.filter(Student.status!= 'APPROVED').all())
#     p_d = len(PlacementDrives.query.filter_by(status = "PENDING").all())
#     total_active_drives = len(PlacementDrives.query.all())
